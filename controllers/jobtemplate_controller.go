...
// +kubebuilder:rbac:groups=batch.joboperator.io,resources=jobtemplates,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=batch.joboperator.io,resources=jobtemplates/status,verbs=get;update;patch
